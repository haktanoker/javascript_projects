...
cardNumber = 1;
addButton.addEventListener("click", function deneme() {
    if (firstInput.value == "" || secondInput.value == "") {
        alert("Lütfen iki kart bilgisini de eksiksiz giriniz");
    }
    else {
        cardList.push({ "firstWord": firstInput.value, "secondWord": secondInput.value, "cardId":cardNumber, "isVisible": false});
        firstInput.value = "";
        secondInput.value = "";
        showCards();
        cardNumber++;
