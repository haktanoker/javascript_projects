...
// Aşağıdaki kod, sayfada neye basılırsa basılsın tetikler ve basılan şeyin içerisinde fa-trash-alt class'ı var mı diye kontrol eder
document.addEventListener('click', function (e) {
  if (e.target.classList.contains('fa-trash-alt')) {
    e.target.parentElement.parentElement.style.display = "none";
  } else if (e.target.classList.contains('fa-check')) {
      let decoration = e.target.parentElement.parentElement.querySelector("p");
